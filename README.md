...
## ✍️ Contributing to the Compendium

We welcome submissions from layout designers, typographers, and developers. To add your own preset to the folio:

1. **Fork** this repository.
2. **Export** your completed theme from the Theme Architect (this generates the standardized JSON output).
3. **Name** your file descriptively using snake_case (e.g., `neon_cyberpunk.json` or `oxford_editorial.json`).
4. **Submit a Pull Request** with a brief description of your design intent and a screenshot of the preview canvas.

*Note: Please ensure your preset relies strictly on vanilla CSS and avoids heavy external dependencies.*

## 📜 License

This compendium is licensed under the **MIT License**. 

We believe in the frictionless velocity of open-source ideas. You are free to use, modify, distribute, and apply these presets to both personal and commercial weblogs without restriction.
